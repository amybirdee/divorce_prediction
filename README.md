# divorce_prediction
Divorce prediction using Gottman survey data

- This project builds machine learning models to predict the likelihood of divorce based on responses to a marital satisfaction survey. The dataset contains 170 responses across 54 psychology-based items that measure aspects of relationship satisfaction, emotional attunement and conflict dynamics
